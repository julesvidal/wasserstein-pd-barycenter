...
../../install/bin/ttkPersistenceDiagramsBarycenterCmd $fileList -o vtu_outputs/output_barycenter_cluster4 -d 0 -T 100000000 -t 1 -M 0 
...
../../install/bin/ttkPersistenceDiagramsClusteringCmd $fileList -o vtu_outputs/output_clustering -d 0 -T 10 -K 5 -I 1 -A 1 -G 1.0 -P -1 -R 0
