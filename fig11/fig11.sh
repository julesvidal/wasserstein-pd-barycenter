...
fileList=""
for I in {0..47}; do
  fileList="$fileList -i /DATA/data/provided_implementation/data/seaSurfaceHeight/seaSurfaceHeight_diagrams/diagram_"$I".vtu"
  # fileList="$fileList -i ../data/diagrams/seaSurfaceHeight/diagram_"$I".vtu"
done
ttkPersistenceDiagramsClusteringCmd $fileList -o vtu_outputs/output_clustering -d 0 -T 10 -K 4 -A 1 -I 1 -G 1.0
